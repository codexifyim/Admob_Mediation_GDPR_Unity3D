...
![Mediation Networks](<Mediation_Networks.png>)
...
![Click here in admob](Privacy_GDPR_Form.png)

Form templates are available just create and add your apps in the list

![Form templates are available just create and add your apps in the list](forms_consent.png)
